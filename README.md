# Laporan Metode Profile Matching
...
Sebuah perusahaan ingin memilih karyawan terbaik untuk dipromosikan menjadi **Team Leader** berdasarkan beberapa kriteria penilaian menggunakan metode **Profile Matching**.
...
# =========================
# 5. Core Factor & Secondary Factor
# =========================
...
print("\n=== KESIMPULAN ===")
print(
    f"Kandidat terbaik adalah "
    f"{terbaik['Kandidat']} "
    f"dengan nilai {terbaik['Nilai Akhir']}"
)
```
